...
For references, see:
`http://nitro9.earth.uni.edu/doctor/homepage.html <http://nitro9.earth.uni.edu/doctor/homepage.html>`_ (dead link),
`http://www.drwhoguide.com/ <http://www.drwhoguide.com/>`_.
...
- \*
 ...
 Submitted by David Adler (under the name \ *doctorwho_oldskool*\ ).
