...
standard (\ *Codes for the representation of names of countries
and their subdivisions -- Part 2: Country subdivision code*\ ). See
`http://en.wikipedia.org/wiki/ISO_3166-2 <http://en.wikipedia.org/wiki/ISO_3166-2>`_.
...
- \*
 ...
 over the previous five months, finally used `WWW::Mechanize <http://search.cpan.org/search?query=WWW%3a%3aMechanize&mode=module>`_
 to scrape all \ ``ISO_3166-2:\ *cc*\ ``\  pages listed on
 `http://en.wikipedia.org/wiki/ISO_3166-2 <http://en.wikipedia.org/wiki/ISO_3166-2>`_ and `Text::Unidecode <http://search.cpan.org/search?query=Text%3a%3aUnidecode&mode=module>`_ to
...
- \*
 ...
 The default country remains \ ``nl``\ .
...
- \*
 ...
 Abigail submitted a \ *netherlands*\  theme, with the names of the Dutch
 provinces.
