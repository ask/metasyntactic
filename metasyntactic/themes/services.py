...
A bigger services lists is used by \ **nmap**\ :
`http://www.insecure.org/nmap/data/nmap-services <http://www.insecure.org/nmap/data/nmap-services>`_.
A huge list of services can also be found at
`http://www.graffiti.com/services <http://www.graffiti.com/services>`_.

The reference list is given by the IANA, and available at
`http://www.iana.org/assignments/port-numbers <http://www.iana.org/assignments/port-numbers>`_.
...
Updated and made automatically updatable with the \ *graffiti.com*\  list
